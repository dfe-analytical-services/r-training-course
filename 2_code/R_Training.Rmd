...
4. Write a code chunk which loads in the <span class="code">tidyverse</span> library and the School Workforce Census data - the code and outputs should be hidden (when you're loading the data you'll need <span class="code">../1_data/swfc_2016_machine_readable.csv</span>, because the R Markdown file is saved in the <span class="code">2_code</span> folder, so the <span class="code">../</span> says 'go back up one step')
...
```{r, eval=FALSE}
  render('2_code/region_factsheet.Rmd', 
         ...
         #They will be stored in the 3_outputs directory
```
