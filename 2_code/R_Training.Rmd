...
<div class="activity"><b>Activity:</b> Adapt the <span class="code">for</span> loop above to create an empty object and at each iteration add the result from the <span class="code">if</span> statement to that object. The functions you'll need are below:
```{r sec9_7,eval=FALSE}
...
<div class="activity"><b>Activity:</b> Write the function below out and run it. As 2 while always be greater than 1 what is going to happen?
<br/>
```{r sec9_8,eval=FALSE}
while(1<2){
