...
<br/>
<div class="activity"><b>Activity A6.1:</b> Calculate the total number of full time posts which are vacant, by Government Office Region, using the function <span class="code">sum()</span>. Remember to turn the full time posts column into a data type which can be summed.</div>
<br/>
<hr/>
<h5><b>Filtering:</b></h5>
...
<br/>
<div class="activity"><b>Activity A6.3:</b> The big one - use <span class="code">dplyr</span> to find out what percentage of teaching assistants in secondary schools (not including all through schools) are in the East of England. These are the functions you'll need to run:
...
<div class="activity"><b>Activity A7.5:</b> Adjust the code slightly to produce a line graph:
...
<div class="activity"><b>Activity A8.1:</b> First, explain what the colon between <span class="code">Tot_Workforce_HC</span> and <span class="code">Perc_Minority_Ethnic_Aux_Staff</span> means.
...
<br/>
<div class="activity"><b>Activity A8.2:</b> It's coming up with <span class="code">NA</span>. What's the argument in <span class="code">min</span> or <span class="code">max</span> that we need to add in to return a result?
</div>
<br/>
...
<br/>
<div class="activity"><b>Activity A8.3:</b> Pick a variable and calculate the range. Think about the arguments you need to use.
</div>
...
<br/>
<div class="activity"><b>Activity A8.4:</b> Create an object (a correlation matrix) which has the correlations for all the columns between <span class="code">StatutoryLowAge</span> and <span class="code">Tot_Workforce_HC</span>.
</div>
<hr/>
...
<br/>
<div class="activity"><b>Activity A8.5:</b> Test whether schools in Camden LA District have a significantly higher percentage of vacant posts (column name is <span class="code">FT_Vacant_Posts</span>) than England as a whole, using a t-test.
...
<br/>
<div class="activity"><b>Activity A8.6:</b> Test whether schools in Camden and Northumbria LA Districts have significantly different percentage of vacant posts (column name is <span class="code">FT_Vacant_Posts</span>) than England as a whole, using a two sample t-test.
</div>
<br/>
<div class="tip"><b>Tip:</b>
...
<div class="activity"><b>Activity A9.5:</b> Run <span class="code">myfunc(10)</span>. What comes out in the Console? What happens if we put <span class="code">my_func_output <-</span> in front of it?</div>
<br/>
