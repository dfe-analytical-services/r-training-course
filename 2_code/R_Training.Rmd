...
* A <span class="code">for</span> loop - a function that will repeat a task for every item in a list
...
function(condition to be met){
  action to be carried out if condition is met
}
```

<h5><b><span class="code">if</span></b></h5>
...
So now if our random number is less than or equal to the probability a teacher is male that it will print 'It's a boy!'. However, if it's over the probability, nothing will happen.
...
```
<hr/>
<h5><b><span class="code">for</span></b></h5>
<h5><b><<span class="code">while</span></b></h5>
