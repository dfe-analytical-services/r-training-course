...
<br/>
<div class="activity"><b>Activity:</b> Install either the <span class="code">ggplot2</span> package or the <span class="code">tidyverse</span> package of packages, of which <span class="code">ggplot2 is one</span>.
</div>
<br/>
...
ggplot(swfc_16 %>% group_by(School_Type) %>% summarise(ave = mean(Perc_QTS_Teachers,na.rm=TRUE)),
       aes(School_Type,ave)) + 
...
ggplot(swfc_16 %>% group_by(Tot_Teachers_HC,School_Type) %>% summarise(ave = mean(TA_Teacher_Ratio,na.rm=TRUE)),
       aes(Tot_Teachers_HC,ave)) + 
  geom_line(stat="identity")
```
<hr/>
<h5><b>Plotting grouped data:</b></h5>
```{r sec7_6,warning=FALSE}
ggplot(swfc_16,aes(School_Type,fill=School_Phase)) +
  geom_bar()
```

```{r sec7_7,warning=FALSE}
ggplot(swfc_16 %>% group_by(Tot_Teachers_HC,School_Type) %>% summarise(ave = mean(TA_Teacher_Ratio,na.rm=TRUE)),
       aes(Tot_Teachers_HC,ave,col=School_Type)) + 
  geom_line(stat="identity")
```
<hr/>
<h5><b>Styles:</b></h5>
