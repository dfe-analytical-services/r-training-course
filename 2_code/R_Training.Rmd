...
<div class="activity"><b>Activity:</b> Turn all schools which arent an LA maintained school or a special school into 'Not LA maintained'.</div>
<br/>
<hr/>
...
<br/>
<div class="activity"><b>Activity:</b> The big one - use <span class="code">dplyr</span> to find out what percentage of teaching assistants in secondary schools (not including all through schools) are in the East of England. These are the functions you'll need to run:
...
<div class="activity"><b>Activity:</b> Apply all of these functions to the graphs you've previously produced.
</div>
...
<br/>
<div class="activity"><b>Activity:</b> It's coming up with <span class="code">NA</span>. What's the argument in <span class="code">min</span> or <span class="code">max</span> that we need to add in to return a result?
</div>
<br/>
...
<div class="activity"><b>Activity:</b> How could we streamline the code we've just written by replacing object names?
</div>
<hr/>
...
1. We create an object with nothing in it called <span class="code">gender</span> - this is to put the record for whether each fictitious teacher is male or female in
2. We write the <span class="code">for</span> loop argument:
    + The <span class="code">i</span> is the name of an object that will take a different value at each iteration (1st iteration, 2nd iteration, etc) of the for loop
    + <span class="code">in 1:10</span> details the different values <span class="code">i</span> will take: 1st iteration - i=1, 2nd iteration i=2, etc.

3. The action to execute at each stage between the curly braces, which in this instance is the <span class="code">if</span> statement from above, adapted so that a new random number is generated for each iteration, and depending on the outcome either 'M' or 'F' is added to the <span class="code">gender</span> object using the <span class="code">c()</span> function
