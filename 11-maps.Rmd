...
wiltshire_schools_df <- "data/wiltshire_schools.csv" %>% read_csv()
wiltshire_schools <- SpatialPointsDataFrame(coords = wiltshire_schools_df %>% select(Easting,Northing),
                                            data = wiltshire_schools_df %>% select(-Easting,-Northing),
                                            proj4string = CRS("+init=epsg:27700"))

wiltshire_schools %>% writeOGR(dsn="data/SHPs",layer="wiltshire_schools", driver="ESRI Shapefile")
