--- 
title: "R Training: The new Excel, and more"
...
<!--chapter:end:03-general-coding.Rmd-->
...
<!--chapter:end:04-loading-exploring.Rmd-->
...
<!--chapter:end:05-manipulating-dataframes.Rmd-->
...
<!--chapter:end:08-statistical-operations.Rmd-->
...
```{r sec11_12,echo=FALSE}
head(england_df)
```

You might have noticed that whilst we now have our dataframe, there's no identifier for a Local Authority (name or code), which is present in the <span class="code">data</span> slot of <span class="code">england</span>.
...
england_df <- "data/SHPs/England_LA_2016.shp" %>% 
  readOGR() %>% 
  tidy() %>% 
  as.tbl() %>% 
